	...
	function slotSegHtml(event, seg) {
		...
		html +=
			...
			" style=" +
				...
				"'" +
			">" +
			"<div class='fc-event-inner contextmenu_event' rel='"+event.id+"' data-toggle='context' data-target='.context-menu'>" +
	...
	function buildHTMLForSegment(segment) {
		...
		html +=
			...
			"<div class='fc-event-inner contextmenu_event' rel='"+event.id+"' data-toggle='context' data-target='#context-menu'>";
				...
				// 		<li>
				// 			<a tabindex='-1' style='color:#000;background-color:#fff;' class='event_remark' id='event_remark' rel='"+event.id+"'><i class='fa fa-flag-o' aria-hidden='true'></i> 标记为已处理</a>
				// 		</li>
				// 	</ul>
				// </div>
