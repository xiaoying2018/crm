<?php
    return array(
	 ...
	 'REPLY' => '回复',
	 'SET_READ' => '设置已读',
	 'CONFIRM_TO_SET_MESAAGE_READ' => '确定要标记为已读么？',
	 'PLEASE_CHOOSE_MESSAGE_TO_SET_READ' => '请先选择要标记为已读的站内信！',
	 'SUCCESS_TO_SET_MESSAGE_READ' => '成功标记已读！',
	 'FAILD_TO_SET_MESSAGE_READ' => '标记已读失败，数据无变化！',
