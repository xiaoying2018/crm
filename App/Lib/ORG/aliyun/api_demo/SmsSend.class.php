...
class SmsSend
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = "LTAIwYQCbmWCEHFH"; // AccessKeyId

        $accessKeySecret = "wEZqjA4lwLn162N4rG64ShOSv6FNqF"; // AccessKeySecret
     ...
     * @return stdClass
     */
    public static function sendSms($phone,$signName,$codeName,$code) {
        ...
        // 必填，设置短信接收号码
//        $request->setPhoneNumbers("00818043326866");
...
//        $request->setTemplateCode("SMS_138079875");
        $request->setTemplateCode($codeName);
        // 可选，设置模板参数, 假如模板中存在变量需要替换则为必填项
        $request->setTemplateParam(json_encode(array(  // 短信模板中字段的值
//            "code"=>"12345",
            "code"=>$code,
//            "product"=>$exptime   //有效期，分钟
...
//
//$response = SmsSend::sendSms('00818043326866', '小莺出国', 'SMS_138079875', '1212');
