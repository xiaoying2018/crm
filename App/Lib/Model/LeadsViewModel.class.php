<?php 
	class LeadsViewModel extends ViewModel{
		...
		public function _initialize(){
			$main_must_field = array('leads_id','merge','merge_time','creator_role_id','owner_role_id','create_time','update_time','contacts_id','customer_id','is_deleted','have_time','is_transformed');
