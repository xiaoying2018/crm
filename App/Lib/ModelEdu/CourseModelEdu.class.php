...
class CourseModelEdu extends EducationModelEdu
{
    ...
    public function course_lists ($where=null,$page=1,$pagesize=15)
    {
        ...
        $data =  $this->field( 'c.id,c.name,COUNT(1) section_total ,c.category, sum(c_sec.duration) time_long, c.member_type, c.detail, c.pic, c.create_at, c.update_at, mxu_c.full_name creator_name, mxu_u.full_name updator_name' )
